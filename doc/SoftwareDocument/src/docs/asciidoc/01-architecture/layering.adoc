...
External libraries, yet maintained by us:

* `api-spec` -- containing the OpenAPI specification and generated sources
...
* `thirdparty-spec` -- external systems (OpenAPI/WSDL) own-written client SDK (outsource generated code)
* `etest` -- end-to-end system tests residing outside to decouple; only gets environment base URL for blackbox access
...
include::{adrsdir}/coding/code-generation.adoc[leveloffset=+1]
