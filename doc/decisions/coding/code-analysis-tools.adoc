...
** It is required that it's possible to use @Suppress annotations.
...
* ktlint
** More a auto-formatter than static code analsysis.
** Configured via the `.editorconfig` file; flat list of properties to en/disable rules.
** Can be included by Detekt (gradle plugin).

*Decision*

* Use Detekt; seems mature, many rules, IntelliJ plugin, suppress annotation.
* Do NOT use ktlint, detekt is sufficient (what's its additional benefit?), and configuration is cumbersome.
